        ...
        <option value="Blog" <?= (isset($type) && $type == 'Blog') ? 'selected' : '' ?>>Blog</option>
                                ...
                                @if($news->image)
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <img src="{{ asset('storage/' . $news->image) }}" alt="Academic Image" class="img-thumbnail" width="200">
                                    </div>
                                @endif
                                <div class="form-group">
                                    <label for="name">Description:</label>
                                    <textarea class="form-control editor" id="description" name="description">{!! old('description', $news->description) !!}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
