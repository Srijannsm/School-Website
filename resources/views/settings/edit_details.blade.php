            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('school_details.update', $schoolDetails->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($schoolDetails->logo)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $schoolDetails->logo) }}" alt="Logo"
                                                id="current-logo" style="max-width: 150px;">
                                        </div>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="contact_numbers" name="contact_numbers"
                                        value="{{ $schoolDetails->contact_numbers }}" placeholder="Enter Contact Numbers">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="establishment_year"
                                        name="establishment_year" value="{{ $schoolDetails->establishment_year }}"
                                        placeholder="Enter Establishment Year" min="1900" max="{{ date('Y') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="number_of_students"
                                        name="number_of_students" value="{{ $schoolDetails->number_of_students }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="number_of_staffs"
                                        name="number_of_staffs" value="{{ $schoolDetails->number_of_staffs }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="programs_offered" name="programs_offered" rows="4"
                                        placeholder="Enter Programs Offered">{{ $schoolDetails->programs_offered }}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
